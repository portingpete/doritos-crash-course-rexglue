...
Require-Text $redirectPath "#define __imp__XamUserGetDeviceContext doritos_XamUserGetDeviceContext" "Import redirect header"
Require-Text $redirectPath "#define __imp__XamUserReadProfileSettings doritos_XamUserReadProfileSettings" "Import redirect header"
Require-Text $redirectPath "#define __imp__XamUserWriteProfileSettings doritos_XamUserWriteProfileSettings" "Import redirect header"
Require-Text $redirectPath "#define __imp__XamContentCreateEx doritos_XamContentCreateEx" "Import redirect header"
Require-Text $overridePath "kLiveSigninState = 2" "Profile override implementation"
Require-Text $overridePath "kSyntheticSigninInfoFlags = 0x00000001u" "Profile override implementation"
Require-Text $overridePath "XUSER_INFO_FLAG_LIVE_ENABLED" "Profile override implementation"
Require-Text $overridePath "guest bit clear" "Profile override implementation"
...
Require-Text $overridePath "doritos_XamUserGetDeviceContext" "Profile override implementation"
Require-Text $overridePath "doritos_XamUserReadProfileSettings" "Profile override implementation"
Require-Text $overridePath "doritos_XamUserWriteProfileSettings" "Profile override implementation"
Require-Text $overridePath "doritos_XamContentCreateEx" "Profile override implementation"
Require-Text $overridePath "PPC_STORE_U32(info_ptr + 8, kSyntheticSigninInfoFlags)" "Profile override implementation"
Require-Text $overridePath "ShouldAllowPrivilege" "Profile override implementation"
Require-Text $overridePath "0x000000FEu" "Profile override implementation"
